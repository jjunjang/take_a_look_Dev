            ...
            protected String doInBackground(String... params) {
                ...
                try {
                    ...
                    if(conn != null){ // 연결되었으면
                        ...
                        System.out.println("GET Response Code : " + responseCode + "// 200이면 oK" );
    ...
    protected void showList() {
        try {
            ...
            for (int i = 0; i < peoples.length(); i++) {
                ...
                mAdapter.addItem(movieImg, titleKor, averageRating);
...
//                System.out.println("c :  [%%" + c + "%%]");
    ...
    public class ListViewAdaptertest extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            ListViewItem listViewItem = mListData.get(position);
